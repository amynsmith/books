...
export { bigOak, defineRequestType, storage, request, requestType, availableNeighbors, everywhere, sendGossip,
   broadcastConnections, findRoute, routeRequest, findInStorage, network, findInRemoteStorage, anyStorage, chicks};